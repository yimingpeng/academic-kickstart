...
[[experience]]
  ...
  * Designing and developing a decentralized network analysis system with real-time visualization that can automatically detect anomaly packets from online network traffic. Within a simulated network environment, the system achieves 90\% recognition rate and performs approximately three times faster than the centralized baseline system.  
  * Implementing existing LDA algorithms for experiments (MATLAB)
